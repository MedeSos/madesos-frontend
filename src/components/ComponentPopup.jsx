...
const ComponentPopup = (props) => {
  ...
  return (
    <div
      ...
      className="invisible opacity-0 fixed inset-y-0 inset-x-0 bg-black/70 transition-[opacity_500ms]"
    >
      <div className="m-[70px_auto] p-5 bg-[#fff] rounded-md w-[30%] relative transition duration-5000 ease-in-out">
        ...
        <span
          ...
          className="absolute top-5 right-8 transition duration-200 text-3xl font-bold no-underline text-[#333] cursor-pointer text-black"
        >
          &times;
        </span>
